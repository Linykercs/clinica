// Model de fila de espera para horarios ocupados
// Ciclo de status: aguardando → notificado → confirmado / expirado / desistiu
...
const filaEsperaSchema = new mongoose.Schema({
  ...
  expira_em:         { type: Date, default: null }, // notificado_em + 2h para o paciente confirmar
